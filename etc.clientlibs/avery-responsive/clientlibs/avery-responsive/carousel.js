...
if ($(".homepageFeature").length) {
    ...
    $(".homepageFeature").each(function() {
        ...
        $(this).children(".options").children("h3").click(function() {
            ...
            if ($(this).children(".video").val()) { $(this).parent().parent().children(".playOverlay").removeClass('hide'); } else { $(this).parent().parent().children(".playOverlay").addClass('hide'); }

            if ($(this).children(".hpfColor").val()) { hpfColor = $(this).children(".hpfColor").val(); } else { hpfColor = "Aqua"; }
            color = hpfColor;
        ...
        function autoRotate(theIndex, slides) {
            ...
            // Check if hidden param of video is true to show the overlay of the play button image
            if (objReference.children(".video").val()) { objReference.parent().parent().children(".playOverlay").removeClass('hide'); } else { objReference.parent().parent().children(".playOverlay").addClass('hide'); }

            if (objReference.children(".hpfColor").val()) {
                hpfColor = objReference.children(".hpfColor").val();
